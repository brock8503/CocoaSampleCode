...
The supplied Xcode project builds with Xcode 5.0 on Mac OS X 10.9 and runs on 10.8 or later.
...
1.7 - Now properly resolving the symlink to the Pictures before creating its security scoped bookmark.
